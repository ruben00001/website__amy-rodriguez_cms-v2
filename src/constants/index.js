const devices = [
  { name: '20"', aspectRatio: 1.8, num: 9, dem: 5, width: 1500 }, // width rough guess
  { name: '10"', aspectRatio: 1.71, num: 171, dem: 100, width: 1024 },
  { name: '24"', aspectRatio: 1.6, num: 8, dem: 5, width: 1920 },
  { name: '12"', aspectRatio: 1.4, num: 7, dem: 5, width: 1100 }, // width rough guess
  { name: 'iPad"', aspectRatio: 0.75, num: 3, dem: 4, width: 768 },
  { name: 'Windows', aspectRatio: 0.6, num: 3, dem: 5, width: 420 }, // width rough guess
  { name: 'iPhone +', aspectRatio: 0.57, num: 57, dem: 100, width: 414 },
